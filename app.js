const tutors = [
    {
        ...
        name: "고체역학",
        subject: "Mechanics",
        subjectDisplay: "응용고체역학",
        tagline: "재료의 변형과 파괴를 예측하다",
        price: 45000,
        rating: 4.9,
        reviews: 120,
        img: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=400&q=80",
        bio: "건설/기계 구조 해석 전문가. 구조물의 안전성을 책임지는 역학 원리 강의.",
        education: "서울대학교 기계공학 박사",
        experience: "구조 해석 연구원 8년",
        methodology: "실습 위주, 프로젝트 기반 학습"
    },
    {
        id: 2,
        name: "유체역학",
        subject: "FluidDynamics",
        subjectDisplay: "실전유체역학",
        tagline: "흐르는 모든 것의 법칙을 꿰뚫다",
        price: 50000,
        rating: 5.0,
        reviews: 85,
        img: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&w=400&q=80",
        bio: "F1 레이싱카 공기역학 설계 출신. 눈에 보이지 않는 공기와 물의 흐름을 읽어드립니다.",
        education: "포항공대 기계공학 석사",
        experience: "공기역학 연구소 6년",
...
const reels = [
    {
        ...
        tutorId: 1,
        title: "교량은 어떻게 버티는가?",
        desc: "거대한 다리가 무너지지 않는 이유! 인장과 압축 응력의 상호작용을 시각적으로 분석합니다.",
        tags: ["#고체역학", "#응력해석", "#구조역학"],
        likes: "1.2k",
        comments: 42,
    ...
    },
    {
        ...
        tutorId: 2,
        title: "비행기는 왜 뜨는가?",
        desc: "베르누이 원리와 양력의 비밀. 공기의 흐름이 만들어내는 마법 같은 힘를 확인하세요.",
        tags: ["#유체역학", "#공기역학", "#베르누이"],
        likes: "3.5k",
        comments: 156,
